...
const AppShowcase: FC = () => {
  ...
  const features = [
    { 
      ...
      icon: 'M12 2.25c.414 0 .75.336.75.75v1.5c0 .414-.336.75-.75.75s-.75-.336-.75-.75V3c0-.414.336-.75.75-.75zm0 3c2.485 0 4.5 2.015 4.5 4.5 0 1.398-.507 2.679-1.348 3.668.841.989 1.348 2.27 1.348 3.668 0 2.485-2.015 4.5-4.5 4.5s-4.5-2.015-4.5-4.5c0-1.398.507-2.679 1.348-3.668C8.007 12.429 7.5 11.148 7.5 9.75c0-2.485 2.015-4.5 4.5-4.5zm0 1.5c-1.656 0-3 1.344-3 3s1.344 3 3 3 3-1.344 3-3-1.344-3-3-3zm0 7.5c-1.656 0-3 1.344-3 3s1.344 3 3 3 3-1.344 3-3-1.344-3-3-3z'
    },
    { 
      id: 'voice' as const, 
