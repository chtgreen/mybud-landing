...
const AppShowcase: FC<AppShowcaseProps> = ({ background = 'white' }) => {
  // Detect B2B context by checking if the content override is active
  ...
  const features = [
    ...
    { 
      ...
      icon: 'M3 3h8v8H3V3zm2 2v4h4V5H5zm8-2h8v8h-8V3zm2 2v4h4V5h-4zM3 13h8v8H3v-8zm2 2v4h4v-4H5zm8 0h8v8h-8v-8zm2 2v4h4v-4h-4z'
    },
    { 
      id: 'alerts' as const, 
      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="lg:w-1/2">
            <IPhoneFeatureMockup featureType={activeFeature} isB2B={isB2B} />
          </div>
