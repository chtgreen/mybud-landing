            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12 xl:gap-16 w-full">
              <div className="lg:w-1/2 text-center lg:text-left">
                ...
                <h1
                  ...
                  style={!isB2BContext ? {
                    textShadow: '0 4px 15px rgba(0, 0, 0, 0.4), 0 2px 2px rgba(0, 0, 0, 0.4)',
                ...
                <div className="flex flex-col gap-6 items-center sm:items-start mb-10 hero-animate-6">
                  <div className="flex flex-col sm:flex-row gap-4 w-full justify-center lg:justify-start">
                    <button
                      className="inline-flex items-center justify-center rounded-2xl px-10 py-5 text-xl font-bold bg-[#eb4c80] text-white hover:bg-[#d13a6a] transition-all duration-300 hover:scale-105 shadow-[0_20px_40px_rgba(235,76,128,0.25)] border-0"
                  ...
                  {!isB2BContext && (
                    <div className="text-sm font-semibold text-white/95 px-2 flex gap-4 items-center bg-black/10 backdrop-blur-md py-3 rounded-2xl border border-white/10 w-fit">
                      <span className="line-through text-white/40 text-base ml-2">R$ 299</span>
                      <span className="bg-emerald-500 text-white text-[10px] px-2 py-0.5 rounded-md font-bold tracking-wider">OFERTA ÚNICA</span>
                      <span className="text-2xl text-emerald-300 font-bold drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)] pr-2">R$ 190</span>
                    </div>
                  )}
                </div>
                ...
                {!isB2BContext && (
                  <button
                    className="lg:hidden inline-flex items-center justify-center gap-2 rounded-xl px-6 py-3 text-base font-medium bg-white/10 backdrop-blur-sm text-white hover:bg-white/20 transition-colors border border-white/30 mb-8"
