...
const Header: React.FC<HeaderProps> = ({
  ...
  const navButtonClass = [
    ...
    isIndustry
      ...
      : isCollective
        ? (isScrolled || isMenuOpen ? "text-zinc-800 hover:text-[#288664]" : "text-[#288664] hover:text-[#1e664c]")
        : isScrolled || isMenuOpen
        ...
        <div className="flex items-center justify-between gap-8 relative">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className={`md:hidden p-2 rounded-xl transition-colors ${isIndustry ? 'text-white hover:bg-zinc-900' : isCollective ? 'text-[#288664] hover:bg-emerald-50' : isScrolled || isMenuOpen ? 'text-zinc-900 hover:bg-zinc-100' : 'text-white hover:bg-white/10'}`}
            >
              {isMenuOpen ? (
