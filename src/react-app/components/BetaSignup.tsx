    ...
    <section id="beta" className={`py-20 cta-organic organic-background ${bgClass}`}>
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-gradient-to-br from-[#D5C0FD]/30 to-[#F9C9DE]/30 rounded-2xl p-8 shadow-lg border-2 border-[#D5C0FD]/50">
            <h3 className="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
              <svg className="w-6 h-6 text-[#eb4c80]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-[#eb4c80] flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
