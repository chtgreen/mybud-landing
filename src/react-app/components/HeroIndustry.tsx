      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-7xl mx-auto flex flex-col items-start text-left">
          ...
          <div className="flex flex-col items-start justify-center mb-12 md:mb-16 w-full">
            <h1 className="text-3xl md:text-6xl lg:text-7xl font-black leading-[1.05] md:leading-[0.9] tracking-tighter text-white lowercase flex flex-col items-start select-none w-full whitespace-pre-line">
