...
const getFeatureIcon = (featureKey: string, isB2BContext: boolean): React.ReactElement | null => {
	if (isB2BContext) {
		switch (featureKey) {
			case 'journal':
	...
	switch (featureKey) {
		...
		case 'alerts':
			return (
				<>
					{getFeatureIcon('alerts', isB2BContext)}
				</>
			);
		case 'guides':
			return (
...
const FeaturesSection: FC<FeaturesSectionProps> = ({ background = 'gray' }) => {
	// Detect if we're in B2B context by checking namespace
						...
						<div className="flex items-start space-x-4">
							...
							>
								<svg
									...
									strokeWidth="1.5"
								>
									{getFeatureIcon('journal', isB2BContext)}
								</svg>
							</div>
							<div>
								<h3
						...
						<div className="flex items-start space-x-4">
							...
							>
								<svg
									...
									strokeWidth="1.5"
								>
									{getFeatureIcon('voice', isB2BContext)}
								</svg>
							</div>
							<div>
								<h3
