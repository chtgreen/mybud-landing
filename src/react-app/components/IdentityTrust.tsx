            ...
            <div className="p-3 rounded-lg inline-flex mb-4 bg-emerald-100">
              ...
              >
                <path
                  ...
                  d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12H3m18 0h-1.5m-16.5 3.75H3m18 0h-1.5M8.25 19.5v1.5M15.75 3v1.5M15.75 19.5v1.5M8.25 6.75h7.5v10.5h-7.5V6.75zm3.75 2.25v6m-1.5-4.5h3"
                />
              </svg>
            </div>
            <h3 
